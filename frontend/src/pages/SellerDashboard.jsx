        ...
        order.productId && (
            ...
            >
                ...
                <div className="ml-5 text-white flex flex-col justify-center space-y-2 w-full">
                    <h3 className="text-lg font-bold">{order.productId.name || "Unknown Product"}</h3>
                    <p className="text-blue-400 font-extrabold">₹{order.productId.price || "N/A"}</p>
                    <p className="text-gray-400 text-sm">{order.productId.description || "No description available"}</p>
                    <p className="text-yellow-400 font-bold">Status: {order.status}</p>
                    <p className="text-blue-400 font-bold">Customer Name: {order.name}</p>
                    <p className="text-blue-400 font-bold">Phone: {order.mobile}</p>
                    <p className="text-blue-400 font-bold">Address: {order.address}</p>
